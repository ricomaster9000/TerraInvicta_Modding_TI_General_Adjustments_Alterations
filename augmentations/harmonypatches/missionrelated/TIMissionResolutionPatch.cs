    ...
    public class TIMissionResolutionPatch
    {
        public static void GetAllModifiers_Postfix(ref List<TIMissionModifier> __result, TIMissionTemplate mission, bool attacking, TICouncilorState councilor, TIGameState target, float resourcesSpent)
        {
            if (councilor != null && mission != null && target != null && !attacking) {
                ...
                float decreaseBy;
                float agent_follow_up_failures_decrease_chances_of_success_factor = Config.GetValueAsFloat("agent_follow_up_failures_decrease_chances_of_success_factor");
                float agent_follow_up_successes_decrease_chances_of_success_factor = Config.GetValueAsFloat("agent_follow_up_successes_decrease_chances_of_success_factor");
